...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('mazer-assets/vendors/rater-js/style.css') }}">
...
<body>
    ...
    <script src="{{ asset('mazer-assets/vendors/rater-js/rater-js.js') }}"></script>
    <script src="{{ asset('mazer-assets/js/extensions/rater-js.js') }}"></script>
