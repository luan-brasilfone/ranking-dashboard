                ...
                <section id="content-types">
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-sm-12">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <img class="img-fluid w-100" src="{{ asset('mazer-assets/images/samples/banana.jpg') }}"
                                        alt="Card image cap">
                                </div>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12">
                            <div class="card">
                                <div class="card-content">
                                    <img src="{{ asset('mazer-assets/images/samples/motorcycle.jpg') }}" class="card-img-top img-fluid"
                                        alt="singleminded">
                                    <div class="card-body">
                                    ...
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ asset('mazer-assets/images/samples/architecture1.jpg') }}" class="d-block w-100"
                                                    alt="Image Architecture">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ asset('mazer-assets/images/samples/bg-mountain.jpg') }}" class="d-block w-100"
                                                    alt="Image Mountain">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="{{ asset('mazer-assets/images/samples/jump.jpg') }}" class="d-block w-100"
                                                    alt="Image Jump">
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="card">
                                <div class="card-content">
                                    <img class="card-img-top img-fluid" src="{{ asset('mazer-assets/images/samples/origami.jpg') }}"
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <img class="card-img-bottom img-fluid" src="{{ asset('mazer-assets/images/samples/water.jpg') }}"
                    ...
                    <div class="row match-height">
                        <div class="col-12">
                            <div class="card-group">
                                <div class="card">
                                    <div class="card-content">
                                        <img class="card-img-top img-fluid" src="{{ asset('mazer-assets/images/samples/1.png') }}"
                                            alt="Card image cap">
                                        <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <img class="card-img-top img-fluid" src="{{ asset('mazer-assets/images/samples/2.png') }}"
                                            alt="Card image cap" />
                                        <div class="card-body">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <img class="card-img-top img-fluid" src="{{ asset('mazer-assets/images/samples/3.png') }}"
                                            alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <img class="card-img-top img-fluid" src="{{ asset('mazer-assets/images/samples/4.png') }}"
                                            alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">
