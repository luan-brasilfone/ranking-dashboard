                                    ...
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ asset('mazer-assets/images/samples/building.jpg') }}" class="d-block w-100"
                                                    alt="...">
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ asset('mazer-assets/images/samples/1.png') }}" class="d-block w-100" alt="...">
                                            ...
                                            <div class="carousel-item">
                                                <img src="{{ asset('mazer-assets/images/samples/2.png') }}" class="d-block w-100" alt="...">
                                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ asset('mazer-assets/images/samples/banana.jpg') }}" class="d-block w-100"
                                                    alt="...">
                                            </div>
                                            <div class="carousel-item">
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleFade" class="carousel slide carousel-fade"
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <img src="{{ asset('mazer-assets/images/samples/3.png') }}" class="d-block w-100" alt="...">
                                                <div class="carousel-caption d-none d-md-block">
